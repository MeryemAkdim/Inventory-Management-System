...
namespace Login_form
{
    public partial class DeleteCust : Form
    {
        ...
        private void savebtn_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure to delet?", "Delete Document", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE Customers WHERE id_cust = '" + this.comboBox3.Text + "'", con);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
                }
        ...
        {
            // TODO: This line of code loads data into the 'inventory_ManagementDataSet13.Customers' table. You can move, or remove it, as needed.
            this.customersTableAdapter.Fill(this.inventory_ManagementDataSet13.Customers);
